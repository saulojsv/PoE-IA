...
export interface ItemProperty { label: string; value: string }
export interface EquipmentItem { id: string; name: string; baseType: string; slot: string; rarity: ItemRarity; sprite?: string; corrupted?: boolean; quality?: number; armour?: number; itemLevel?: number; requiredLevel?: number; requiredStrength?: number; properties?: ItemProperty[]; stats: string[]; flavorText?: string; impact?: ItemImpact }
